        ...
        <div class="relative z-10 space-y-10">
            ...
            <div class="p-8 bg-slate-50 rounded-2xl border border-slate-100 text-left space-y-4">
                <div class="flex items-start gap-4">
                    ...
                    <p class="text-xs font-bold text-slate-600 uppercase tracking-widest leading-loose">Core Metadata successfully ingested into C-Market registry.</p>
                </div>
                <div class="flex items-start gap-4">
                    <div class="w-6 h-6 bg-emerald-500 rounded-full flex-shrink-0 flex items-center justify-center text-white text-[10px]">✓</div>
            ...
            <p class="text-[9px] font-black text-slate-300 uppercase tracking-[0.3em] pt-10">System Architecture: C-Market v2.0 • Protocol: MERCHANT_NODE_WAITLIST</p>
        </div>
    </div>
</div>
@endsection
