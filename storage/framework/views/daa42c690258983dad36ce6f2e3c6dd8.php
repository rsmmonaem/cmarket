<?php $__env->startSection('title', 'Participant Directory - CMarket'); ?>
<?php $__env->startSection('page-title', 'Global Participant Management'); ?>
                        ...
                        <tr class="group hover:bg-slate-50/80 transition-all duration-300">
                            <td class="px-10 py-8">
                                <div class="flex items-center gap-6">
                                    ...
                                    <div>
                                        <div class="text-sm font-black text-slate-800 mb-1"><?php echo e($user->name); ?></div>
                                        <div class="text-[9px] text-slate-400 font-black uppercase tracking-widest">UID: <?php echo e(str_pad($user->id, 5, '0', STR_PAD_LEFT)); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-10 py-8">
                                <div class="text-xs font-black text-slate-800 mb-1"><?php echo e($user->phone); ?></div>
                                <div class="text-[10px] font-bold text-slate-400 truncate max-w-[180px]"><?php echo e($user->email ?? 'N/A'); ?></div>
                            </td>
                            <td class="px-10 py-8">
