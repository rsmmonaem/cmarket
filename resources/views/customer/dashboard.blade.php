...
<div class="card-solid" style="margin-bottom: 2rem;">
    <h3 style="margin-bottom: 1rem; font-weight: 700;">Welcome back, {{ Auth::user()->name }}! 👋</h3>
    ...
    <div style="margin-top: 1.5rem; padding: 1.25rem; background: rgba(245, 158, 11, 0.1); border: 1px solid var(--warning); border-radius: 0.75rem;">
        ...
        <a href="{{ route('kyc.index') }}" class="btn-solid" style="background-color: var(--warning); color: white;">
            Complete KYC Now
        </a>
    </div>
    @endif
...
<div class="card-solid">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.5rem;">
        <a href="{{ route('products.index') }}" class="card-solid" style="padding: 2rem; text-decoration: none; color: inherit; text-align: center; transition: all 0.3s; background: var(--bg-light); border: 2px solid transparent;" onmouseover="this.style.borderColor='var(--primary)'; this.style.transform='translateY(-5px)'" onmouseout="this.style.borderColor='transparent'; this.style.transform='translateY(0)'">
        ...
        <a href="{{ route('wallet.index') }}" class="card-solid" style="padding: 2rem; text-decoration: none; color: inherit; text-align: center; transition: all 0.3s; background: var(--bg-light); border: 2px solid transparent;" onmouseover="this.style.borderColor='var(--primary)'; this.style.transform='translateY(-5px)'" onmouseout="this.style.borderColor='transparent'; this.style.transform='translateY(0)'">
        ...
        <a href="{{ route('referrals.index') }}" class="card-solid" style="padding: 2rem; text-decoration: none; color: inherit; text-align: center; transition: all 0.3s; background: var(--bg-light); border: 2px solid transparent;" onmouseover="this.style.borderColor='var(--primary)'; this.style.transform='translateY(-5px)'" onmouseout="this.style.borderColor='transparent'; this.style.transform='translateY(0)'">
            <div style="font-size: 2.5rem; margin-bottom: 1rem;">🤝</div>
        ...
        <a href="{{ route('customer.commissions') }}" class="card-solid" style="padding: 2rem; text-decoration: none; color: inherit; text-align: center; transition: all 0.3s; background: var(--bg-light); border: 2px solid transparent;" onmouseover="this.style.borderColor='var(--primary)'; this.style.transform='translateY(-5px)'" onmouseout="this.style.borderColor='transparent'; this.style.transform='translateY(0)'">
            <div style="font-size: 2.5rem; margin-bottom: 1rem;">📊</div>
