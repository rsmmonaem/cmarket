...
@section('title', 'Deploy Taxonomy Node - EcomMatrix')
                ...
                <div class="card-premium p-8 md:p-10 space-y-8">
                    <div class="space-y-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" required placeholder="Initialize identifier..." 
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="description" rows="5" placeholder="Define the operational scope of this node..."
                                      class="w-full px-5 py-4 bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl text-sm font-bold text-slate-700 dark:text-slate-200 focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all shadow-sm">{{ old('description') }}</textarea>
